...
<form>
<td>Show all dara:</td><br><br>

<input type="submit" value="Click" name="click"><br><br>
...
<input type="submit" value="帳密提交" name="sclick"><br><br>
<input type="submit" value="帳密註冊" name="click1">
</form>
